  ...
  internal static class BirdShadowManager
  {
    ...
    public static void Update(Player player, GameTime gameTime)
    {
                ...
                && (double) BirdShadowManager.BirdShadowList.Count < 5.0 * DayCycle.timeSpeed)
      {
        ...
        {
          case 0:
            startingPoint = new Vector2((float) Game1.rand.Next(-200, 21500), -200f);
            break;
          case 1:
            startingPoint = new Vector2(18000f, (float) Game1.rand.Next(-200, 15000));
            break;
          case 2:
            startingPoint = new Vector2((float) Game1.rand.Next(-200, 21500), 15000f);
            break;
          default:
            startingPoint = new Vector2(-200f, (float) Game1.rand.Next(-200, 15000));
            break;
        }
        BirdShadowManager.BirdShadowList.Add(
            new BirdShadow(startingPoint, Game1.rand.NextDouble() * Math.PI * 2.0, 
