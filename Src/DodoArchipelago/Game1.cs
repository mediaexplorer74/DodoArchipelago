...
namespace DodoTheGame
{
  ...
  partial class Game1 : Game
  {
    ...
    public Vector2 dodoScreenLocation;
    public Vector2 dodoCenteredScreenLocation;
      ...
      if (this.startupIntroDone && !Recorder.rerendering)
      {
        ...
        if (!GUIManager.IsGameObstructed)
        {
          ...
          foreach (object obj in list)
          {
            switch (obj)
            {
              case IWorldObject parentWo when !CutsceneManager.IsOverrideInEffect(RenderOverride.Terrain):
                ...
                parentWo.Draw(this.spriteBatch, new Vector2(this.backgroundPosition.X + parentWo.Location.X, this.backgroundPosition.Y + parentWo.Location.Y), gameTime, this, colorn: new Color?(color), inReach: parentWo == Game1.player.inReachObject, inReachAndHasInteractions: parentWo == Game1.player.inReachObject && (parentWo.Interactions[0] != null && parentWo.Interactions[0].ComputeShowState(parentWo, Game1.player) || parentWo.Interactions[1] != null && parentWo.Interactions[1].ComputeShowState(parentWo, Game1.player) || parentWo.Interactions[2] != null && parentWo.Interactions[2].ComputeShowState(parentWo, Game1.player) || parentWo.Interactions[3] != null && parentWo.Interactions[3].ComputeShowState(parentWo, Game1.player)));
                continue;
                ...
                switch (player.currentMovementType)
                {
                  ...
                  case Player.DodoMovement.Bike:
                    if (player.IsBikeInWater)
                    {
                      ...
                      {
                        this.dodoBikeInWaterSprite.Draw(this.spriteBatch, new Vector2((float) ((double) this.dodoScreenLocation.X - 32.0 - 4.0), (float) ((double) this.dodoScreenLocation.Y - 90.0 - 14.0)), gameTime, globaleffect, nightFactor: DayCycle.NightFactor);
                        continue;
                      }
                      if (Wind.GetAngle == 3.0 * Math.PI / 4.0 || Wind.GetAngle == 5.0 * Math.PI / 4.0)
                      {
                        this.dodoBikeInWaterBSprite.Draw(this.spriteBatch, new Vector2((float) ((double) this.dodoScreenLocation.X - 32.0 - 4.0), (float) ((double) this.dodoScreenLocation.Y - 90.0 - 14.0)), gameTime, globaleffect, nightFactor: DayCycle.NightFactor);
                        continue;
                      }
                    ...
                    if (Wind.GetAngle == 7.0 * Math.PI / 4.0 || Wind.GetAngle == Math.PI / 4.0)
                    {
                      this.dodoBikeSprite.Draw(this.spriteBatch, new Vector2((float) ((double) this.dodoScreenLocation.X - 32.0 - 4.0), (float) ((double) this.dodoScreenLocation.Y - 90.0 - 14.0)), gameTime, globaleffect, nightFactor: DayCycle.NightFactor);
                      continue;
                    }
                    if (Wind.GetAngle == 3.0 * Math.PI / 4.0 || Wind.GetAngle == 5.0 * Math.PI / 4.0)
                    {
                      this.dodoBikeBSprite.Draw(this.spriteBatch, new Vector2((float) ((double) this.dodoScreenLocation.X - 32.0 - 4.0), (float) ((double) this.dodoScreenLocation.Y - 90.0 - 14.0)), gameTime, globaleffect, nightFactor: DayCycle.NightFactor);
                      continue;
                    }
                    if ((double) player.bikeVelocity.Y > 0.0)
                    {
                  ...
                  case Player.DodoMovement.Bicycle:
                    ...
                    {
                      this.dodoBicycle1Sprite.Draw(this.spriteBatch, new Vector2(this.dodoScreenLocation.X + (player.facing == 0 ? -42f : -32f), this.dodoScreenLocation.Y - 34f), gameTime, globaleffect, nightFactor: DayCycle.NightFactor);
                      continue;
                    }
                    if (player.actionTime <= this.dodoBicycle1Sprite.MillisecondsPerFrame * this.dodoBicycle1Sprite.TotalFrameCount + this.dodoBicycle2Sprite.MillisecondsPerFrame * this.dodoBicycle2Sprite.TotalFrameCount)
                    {
                      this.dodoBicycle2Sprite.Draw(this.spriteBatch, new Vector2(this.dodoScreenLocation.X + (player.facing == 0 ? -42f : -32f), this.dodoScreenLocation.Y - 34f), gameTime, globaleffect, nightFactor: DayCycle.NightFactor);
                      continue;
                    }
                    this.dodoBicycle3Sprite.Draw(this.spriteBatch, new Vector2(this.dodoScreenLocation.X + (player.facing == 0 ? -42f : -32f), this.dodoScreenLocation.Y - 34f), gameTime, globaleffect, nightFactor: DayCycle.NightFactor);
                    continue;
                  case Player.DodoMovement.Drown:
                    this.dodoSpriteSwimSink.Draw(this.spriteBatch, this.dodoScreenLocation - new Vector2(80f, 20f), gameTime, globaleffect, nightFactor: DayCycle.NightFactor);
                    continue;
                  case Player.DodoMovement.WalkToBike:
                    this.dodoWalkToBikeSprite.Draw(this.spriteBatch, new Vector2((float) ((double) this.dodoScreenLocation.X - 32.0 - 4.0 - 54.0), (float) ((double) this.dodoScreenLocation.Y - 90.0 - 14.0 - 80.0)), gameTime, globaleffect, nightFactor: DayCycle.NightFactor);
                    continue;
                  case Player.DodoMovement.WalkToBicycle:
                    this.dodoWalkToBicycleSprite.Draw(this.spriteBatch, new Vector2(this.dodoScreenLocation.X + (player.facing == 0 ? -50f : -40f), this.dodoScreenLocation.Y - 85f), gameTime, globaleffect, nightFactor: DayCycle.NightFactor);
                    continue;
                  case Player.DodoMovement.TakeNotes:
                    this.dodoTakeNotes.Draw(this.spriteBatch, new Vector2(this.dodoScreenLocation.X, this.dodoScreenLocation.Y - 10f), gameTime, globaleffect, nightFactor: DayCycle.NightFactor);
                    continue;
                  default:
          ...
          if (!CutsceneManager.IsOverrideInEffect(RenderOverride.Butterflies))
          {
            ...
            CutsceneManager.DrawOverride(RenderOverride.Butterflies, this.spriteBatch, gameTime, this, Vector2.Zero);
          if (!CutsceneManager.IsOverrideInEffect(RenderOverride.WindTrails))
          {
            ...
            CutsceneManager.DrawOverride(RenderOverride.WindTrails, this.spriteBatch, gameTime, this, Vector2.Zero);
          if (!CutsceneManager.IsOverrideInEffect(RenderOverride.ForegroundEffects))
          {
            this.spriteBatch.Begin(SpriteSortMode.Immediate);
            Game1.foregroundEffectList.ForEach((Action<IForegroundEffect>) (fe => fe.Draw(this.spriteBatch, gameTime, this.backgroundPosition)));
            this.spriteBatch.End();
          }
          else
            CutsceneManager.DrawOverride(RenderOverride.ForegroundEffects, this.spriteBatch, gameTime, this, Vector2.Zero);
          if (!CutsceneManager.IsOverrideInEffect(RenderOverride.SwimCounter))
          {
            if (Game1.player.currentMovementType == Player.DodoMovement.Swim || Game1.player.currentMovementType == Player.DodoMovement.Drown)
            {
              this.spriteBatch.Begin(SpriteSortMode.Immediate);
              this.drowningIcons[Game1.player.SwimPulseCount > 3 ? 3 : Game1.player.SwimPulseCount].Draw(this.spriteBatch, new Vector2(this.dodoScreenLocation.X - 30f, this.dodoScreenLocation.Y - 60f), gameTime, colorn: new Color?(Color.White * 1f));
              this.spriteBatch.End();
            }
            else
              ((IEnumerable<Sprite>) this.drowningIcons).ToList<Sprite>().ForEach((Action<Sprite>) (p => p.ResetAnimation()));
          }
          else
            CutsceneManager.DrawOverride(RenderOverride.SwimCounter, this.spriteBatch, gameTime, this, Vector2.Zero);
          if (!CutsceneManager.IsOverrideInEffect(RenderOverride.TimeBar))
          {
            if (Game1.player.currentMovementType == Player.DodoMovement.Bicycle || Game1.player.currentMovementType == Player.DodoMovement.WalkToBicycle)
            {
              this.spriteBatch.Begin(SpriteSortMode.Immediate);
              this.timebar.CurrentFrame = (int) Math.Round(21.0 * (double) Game1.player.TimeBar / 100.0, 0);
              this.timebar.Draw(this.spriteBatch, new Vector2(this.dodoScreenLocation.X + 130f, this.dodoScreenLocation.Y - 90f), gameTime, colorn: new Color?(Color.White * 1f));
              this.spriteBatch.End();
            }
          }
          else
