  ...
  internal static class WorldGenerator
  {
        ...
        public static void GenerateWorld(World @world, List<Preset> presetList)
        {
            ...
            world = new World(default)
            {
                ...
                NPCs = new List<INPC>()//NPCManager.Update(world,Game1.gameTime)
            };
            ...
            for (int index = 0; index < 25015; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)minValue1, (int)num6 + 1),
                    (double)Game1.rand.Next(2, 7),
                    Game1.rand.Next(2, 23), 1);
            for (int index = 0; index < 62537; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)minValue2, 2501),
                    (double)Game1.rand.Next(2, 6),
                    Game1.rand.Next(2, 40), 0);
            for (int index = 0; index < 12507; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)num5, 2501),
                    (double)Game1.rand.Next(2, 5),
                    Game1.rand.Next(2, 20), -1);
            for (int index = 0; index < 12507; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)num5, 2501),
                    (double)Game1.rand.Next(8, 15),
                    Game1.rand.Next(7, 30), -1);

            for (int index = 0; index < 2501; ++index)
            {
                if (num6 <= 2501.0)
                    WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                        Game1.rand.Next((int)num6, 2501), (double)Game1.rand.Next(10, 20),
                        Game1.rand.Next(50, 300), -1);
            }
            for (int index = 0; index < 25; ++index)
            {
                ...
                for (int j = 0; (double)j < num5; ++j)
                {
                    ...
                    {
                        WorldGenerator.TileRunner(i, j,
                            (double)Game1.rand.Next(3, 6), Game1.rand.Next(5, 50), -1,
                            speedX: (float)Game1.rand.Next(-10, 11) * 0.1f, speedY: 1f);
                        break;
                    }
                }
            }
            for (int index = 0; index < 40; ++index)
            {
                ...
                for (int j = 0; (double)j < num5; ++j)
                {
                    ...
                    {
                        WorldGenerator.TileRunner(i, j,
                            (double)Game1.rand.Next(10, 15), Game1.rand.Next(50, 130), -1,
                            speedX: (float)Game1.rand.Next(-10, 11) * 0.1f, speedY: 1f);
                        break;
                    }
                }
            ...
            for (int index = 0; index < 10; ++index)
            {
                ...
                for (int j = 0; (double)j < num5; ++j)
                {
                    if (Game1.tile[i, j].active)
                    {
                        WorldGenerator.TileRunner(i, j, (double)Game1.rand.Next(12, 25),
                            Game1.rand.Next(100, 400), -1, 
                            speedX: (float)Game1.rand.Next(-10, 11) * 0.1f, speedY: 3f);

                        WorldGenerator.TileRunner(i, j, (double)Game1.rand.Next(8, 17),
                            Game1.rand.Next(60, 200), -1, 
                            speedX: (float)Game1.rand.Next(-10, 11) * 0.1f, speedY: 2f);

                        WorldGenerator.TileRunner(i, j, (double)Game1.rand.Next(5, 13),
                            Game1.rand.Next(40, 170), -1, 
                            speedX: (float)Game1.rand.Next(-10, 11) * 0.1f, speedY: 2f);
                        break;
                    }
                }
            ...
            for (int index4 = 0; index4 < 12507; ++index4)
            {
                ...
                if (Game1.tile[index5 - 1, index6].active
                            && Game1.tile[index5 - 1, index6].type == (byte)0
                            && Game1.tile[index5 + 1, index6].active
                            && Game1.tile[index5 + 1, index6].type == (byte)0
                            && Game1.tile[index5, index6 - 1].active
                            && Game1.tile[index5, index6 - 1].type == (byte)0
                            && Game1.tile[index5, index6 + 1].active
                            && Game1.tile[index5, index6 + 1].type == (byte)0)
                {
            ...
            for (int index = 0; index < 625; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)minValue1, (int)num5), (double)Game1.rand.Next(3, 4), Game1.rand.Next(2, 5), 7);
            for (int index = 0; index < 750; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)num5, (int)num6), (double)Game1.rand.Next(3, 6), Game1.rand.Next(3, 6), 7);
            for (int index = 0; index < 3752; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)minValue2, 2501), (double)Game1.rand.Next(4, 9), Game1.rand.Next(4, 8), 7);
            for (int index = 0; index < 500; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)minValue1, (int)num5), (double)Game1.rand.Next(3, 4), Game1.rand.Next(2, 5), 6);
            for (int index = 0; index < 625; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)num5, (int)num6), (double)Game1.rand.Next(3, 6), Game1.rand.Next(3, 6), 6);
            for (int index = 0; index < 2501; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)minValue2, 2501), (double)Game1.rand.Next(4, 9), Game1.rand.Next(4, 8), 6);
            for (int index = 0; index < 125; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)minValue1, (int)num5), (double)Game1.rand.Next(3, 4), Game1.rand.Next(2, 5), 9);
            for (int index = 0; index < 250; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)num5, (int)num6), (double)Game1.rand.Next(3, 6), Game1.rand.Next(3, 6), 9);
            for (int index = 0; index < 1250; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)minValue2, 2501), (double)Game1.rand.Next(4, 9), Game1.rand.Next(4, 8), 9);
            for (int index = 0; index < 62; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)minValue1, (int)num5), (double)Game1.rand.Next(3, 4), Game1.rand.Next(2, 5), 8);
            for (int index = 0; index < 125; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)num5, (int)num6), (double)Game1.rand.Next(3, 6), Game1.rand.Next(3, 6), 8);
            for (int index = 0; index < 625; ++index)
                WorldGenerator.TileRunner(Game1.rand.Next(0, 5001),
                    Game1.rand.Next((int)minValue2, 2501), (double)Game1.rand.Next(4, 9), Game1.rand.Next(4, 8), 8);
            ...
            for (int index = 0; index < 5001; ++index)
            {
                ...
                for (int j = 0; (double)j < Game1.worldSurface - 1.0; ++j)
                {
                    if (Game1.tile[i, j].active)
                    {
                        ...
                        {
                            //WorldGenerator.SpreadGrass(i, j);
                            break;
                        }
                        break;
                    }
            ...
            // Experimental
            //WorldGenerator.AddTrees();
            
            //Test: Del it
            WorldGenerator.EveryTileFrame();


            //WorldGenerator.AddPlants();
        ...
        public static void EveryTileFrame()
        {
            for (int i = 0; i < 5001; ++i)
            {
                for (int j = 0; j < 2501; ++j)
                {
                    try
                    {
                        WorldGenerator.TileFrame(i, j, true);
                    }
                    catch { }
                }
            }
        ...
        )
        {
            ...
            while (num1 > 0.0 && (double)num2 > 0.0)
            {
                ...
                for (int index1 = num3; index1 < num4; ++index1)
                {
                    ...
                    {
                        if ((double)Math.Abs((float)index1 - vector2_1.X)
                            + (double)Math.Abs((float)index2 - vector2_1.Y) < strength * 0.5 * (1.0 + (double)Game1.rand.Next(-10, 11) * 0.015))
                        {
                            if (type == -1)
                            {
                                Game1.tile[index1, index2].active = false;
        ...
        {
            WorldGenerator.TileFrame(i - 1, j - 1);
            WorldGenerator.TileFrame(i - 1, j);
            WorldGenerator.TileFrame(i - 1, j + 1);
            WorldGenerator.TileFrame(i, j - 1);
            WorldGenerator.TileFrame(i, j, resetFrame);
            WorldGenerator.TileFrame(i, j + 1);
            WorldGenerator.TileFrame(i + 1, j - 1);
            WorldGenerator.TileFrame(i + 1, j);
            WorldGenerator.TileFrame(i + 1, j + 1);
        ...
        private static void TileFrame(int v1, int v2)
        {
            //TODO
        }

        private static void TileFrame(int v1, int v2, bool resetFrame)
        {
            //TODO
        }
...
public static void generateWorld()
{
    ...
    for (int j = 0; (double) j < num5; ++j)
    {
        ...
        {
        WorldGenerator.TileRunner(i, j, (double) Game1.rand.Next(12, 25),
            Game1.rand.Next(100, 400), -1, speedX: (float) Game1.rand.Next(-10, 11) * 0.1f, speedY: 3f);
        WorldGenerator.TileRunner(i, j, (double) Game1.rand.Next(8, 17), 
            Game1.rand.Next(60, 200), -1, speedX: (float) Game1.rand.Next(-10, 11) * 0.1f, speedY: 2f);
        WorldGenerator.TileRunner(i, j, (double) Game1.rand.Next(5, 13), 
            Game1.rand.Next(40, 170), -1, speedX: (float) Game1.rand.Next(-10, 11) * 0.1f, speedY: 2f);
        break;
        }
    }
    }
...
public static void AddTrees()
{
    ...
    for (int index2 = 20; (double) index2 < Game1.worldSurface; ++index2)
    {
        if (Game1.tile[index1, index2].active 
                    ...
                    && Game1.tile[index1 - 1, index2].active 
                    && Game1.tile[index1 - 1, index2].type == (byte) 2 
                    && Game1.tile[index1 + 1, index2].active 
                    && Game1.tile[index1 + 1, index2].type == (byte) 2 
                    && WorldGenerator.EmptyTileCheck(index1 - 2, index1 + 2, index2 - 14, index2 - 1))
        {
        bool flag1 = false;
        bool flag2 = false;
...
public static void PlaceTile(int i, int j, int type, bool mute = false)
{
    ...
    case 4:
        ...
        WorldGenerator.SquareTileFrame(i, j);
        break;
        }
        break;
    case 10:
        ...
        {
        WorldGenerator.PlaceDoor(i, j - 1, type);
        WorldGenerator.SquareTileFrame(i, j);
        break;
        }
        if (Game1.tile[i, j + 1].active || Game1.tile[i, j + 2].active || !Game1.tile[i, j + 3].active || !Game1.tileSolid[(int) Game1.tile[i, j + 3].type])
...
public static void KillWall(int i, int j, bool fail = false)
{
    ...
    if (fail)
    {
    WorldGenerator.SquareWallFrame(i, j);
    }
    else
    {
    int Type = 0;
...
{
    if (i < 0 || j < 0 || i >= 5001 || j >= 2501 
            || !Game1.tile[i, j].active || j 
            >= 1 && Game1.tile[i, j - 1].active
            && Game1.tile[i, j - 1].type == (byte) 5 
            && Game1.tile[i, j].type != (byte) 5 
            && (Game1.tile[i, j - 1].frameX != (short) 66 
            || Game1.tile[i, j - 1].frameY < (short) 0 
            || Game1.tile[i, j - 1].frameY > (short) 44) 
            && (Game1.tile[i, j - 1].frameX != (short) 88 
            || Game1.tile[i, j - 1].frameY < (short) 66 
            || Game1.tile[i, j - 1].frameY > (short) 110) 
            && Game1.tile[i, j - 1].frameY < (short) 198)
    return;
    ...
    if (Game1.tile[i, j].type == (byte) 4)
        Type = 6;
    if (Game1.tile[i, j].type == (byte) 5 
        || Game1.tile[i, j].type == (byte) 10 
        || Game1.tile[i, j].type == (byte) 11)
        Type = 7;
...
public static void UpdateWorld()
{
    ...
    //patch 
    if (Game1.worldSurface == 0)
        Game1.worldSurface = 1;
    ...
    if (Game1.tile[i1, index2].active && Game1.tile[i1, index2].type == (byte) 2)
    {
        ...
        WorldGenerator.PlaceTile(i1, j1, 3, true);
        ...
        for (int j2 = j1; j2 < num4; ++j2)
        {
            ...
            {
            WorldGenerator.SpreadGrass(i2, j2, repeat: false);
            if (Game1.tile[i2, j2].type == (byte) 2)
                WorldGenerator.SquareTileFrame(i2, j2);
            }
        }
        }
    }
...
public static void AddPlants()
{
    ...
    for (int index = 1; index < 2501; ++index)
    {
        ...
        WorldGenerator.PlaceTile(i, index - 1, 3, true);
    }
    }
}
...
public static void SpreadGrass(int i, int j, int dirt = 0, int grass = 2, bool repeat = true)
{
    ...
    for (int j1 = num3; j1 < num4; ++j1)
    {
        ...
        WorldGenerator.SpreadGrass(i1, j1, dirt, grass);
    }
    }
}
...
{
    WorldGenerator.WallFrame(i - 1, j - 1);
    WorldGenerator.WallFrame(i - 1, j);
    WorldGenerator.WallFrame(i - 1, j + 1);
    WorldGenerator.WallFrame(i, j - 1);
    WorldGenerator.WallFrame(i, j, resetFrame);
    WorldGenerator.WallFrame(i, j + 1);
    WorldGenerator.WallFrame(i + 1, j - 1);
    WorldGenerator.WallFrame(i + 1, j);
    WorldGenerator.WallFrame(i + 1, j + 1);
...
public static void EveryTileFrame()
{
    //WorldGenerator.noLiquidCheck = true;
    for (int i = 0; i < Game1.maxTilesX; ++i)
    {
        //Debug.WriteLine("Finding tile frames: " 
        //    + ( (double)((double)i / (double)Game1.maxTilesX) * 100.0 + 1.0 ) + "%");
        for (int j = 0; j < Game1.maxTilesY; ++j)
        {
            WorldGenerator.TileFrame(i, j, true);
            WorldGenerator.WallFrame(i, j, true);
        }
    }
    //WorldGenerator.noLiquidCheck = false;
}
...
public static void TileFrame(int i, int j, bool resetFrame = false)
{
    ...
    if (type == 3)
    {
        WorldGenerator.PlantCheck(i, j);
    }
    else
    {
        WorldGenerator.mergeUp = false;
        WorldGenerator.mergeDown = false;
        WorldGenerator.mergeLeft = false;
        WorldGenerator.mergeRight = false;
        if (i - 1 < 0)
        {
            num1 = type;
            index1 = type;
        ...
        switch (type)
        {
            ...
            case 5:
                ...
                {
                    if (Game1.tile[i, j].frameX >= (short)22
                                      && Game1.tile[i, j].frameX <= (short)44
                ...
                if (Game1.tile[i, j].frameY >= (short)132
                                && Game1.tile[i, j].frameY <= (short)176
                                && (Game1.tile[i, j].frameX == (short)0
                                || Game1.tile[i, j].frameX == (short)66
                                || Game1.tile[i, j].frameX == (short)88))
                ...
                if (Game1.tile[i, j].frameX == (short)66
                    && (Game1.tile[i, j].frameY == (short)0
                    || Game1.tile[i, j].frameY == (short)22
                    || Game1.tile[i, j].frameY == (short)44)
                    || Game1.tile[i, j].frameX == (short)88
                    ...
                    || Game1.tile[i, j].frameY == (short)110)
                    || Game1.tile[i, j].frameX == (short)44
                    && (Game1.tile[i, j].frameY == (short)198
                    || Game1.tile[i, j].frameY == (short)220
                    || Game1.tile[i, j].frameY == (short)242)
                    || Game1.tile[i, j].frameX == (short)66
                    && (Game1.tile[i, j].frameY == (short)198
                    || Game1.tile[i, j].frameY == (short)220
                    || Game1.tile[i, j].frameY == (short)242))
                {
                    ...
                    WorldGenerator.KillTile(i, j);
                else if (num2 != type && Game1.tile[i, j].frameY < (short)198
                                && (Game1.tile[i, j].frameX != (short)22
                                && Game1.tile[i, j].frameX != (short)44
                                || Game1.tile[i, j].frameY < (short)132))
                {
                ...
                break;
            case 10:
                if (WorldGenerator.destroyObject)
                    return;
                ...
                if (flag1)
                {
                    WorldGenerator.destroyObject = true;
                    WorldGenerator.KillTile(i, j1);
                    WorldGenerator.KillTile(i, j1 + 1);
                    WorldGenerator.KillTile(i, j1 + 2);
                    Item.NewItem(i * 16, j * 16, 16, 16, 25);
                }
                WorldGenerator.destroyObject = false;
                return;
            case 11:
                if (WorldGenerator.destroyObject)
                    return;
                ...
                if (!Game1.tile[index4, num7 - 1].active
                                || !Game1.tileSolid[(int)Game1.tile[index4, num7 - 1].type]
                                || !Game1.tile[index4, num7 + 3].active
                                || !Game1.tileSolid[(int)Game1.tile[index4, num7 + 3].type])
                {
                    flag2 = true;
                    WorldGenerator.destroyObject = true;
                    Item.NewItem(i * 16, j * 16, 16, 16, 25);
        ...
        if (type == 0)
        {
            for (int index5 = 0; index5 < 12; ++index5)
            {
                if (index5 == 1 || index5 == 6 || index5 == 7 || index5 == 8 || index5 == 9)
                {
                    ...
                    {
                        WorldGenerator.TileFrame(i, j - 1);
                        if (WorldGenerator.mergeDown)
                            num2 = type;
                    }
                    if (index3 == index5)
                    {
                        WorldGenerator.TileFrame(i, j + 1);
                        if (WorldGenerator.mergeUp)
                            index3 = type;
                    }
                    if (index1 == index5)
                    {
                        WorldGenerator.TileFrame(i - 1, j);
                        if (WorldGenerator.mergeRight)
                            index1 = type;
                    }
                    if (index2 == index5)
                    {
                        WorldGenerator.TileFrame(i + 1, j);
                        if (WorldGenerator.mergeLeft)
                            index2 = type;
                    }
                    if (num1 == index5)
                        num1 = type;
        ...
        if (type == 2)
        {
                ...
                else if (num5 != -1)
                {
                    ...
                    if (num9 == 2)
                    {
                        ...
                        rectangle.Y = 180;
                          ...
                          || num2 == type && index3 == num10 && index1 == type && index2 == type
                          || num2 == type && index3 == type && index1 == num10 && index2 == type
                          || num2 == type && index3 == type && index1 == type && index2 == num10)
            {
                if (num9 == 0)
                {
                    rectangle.X = 18;
            ...
            if ((num2 == type || num2 == num10) && (index3 == type || index3 == num10)
                          && (index1 == type || index1 == num10) && (index2 == type || index2 == num10))
            {
                if (num1 != type && num1 != num10 && (num3 == type || num3 == num10)
                                && (num4 == type || num4 == num10) && (num5 == type || num5 == num10))
                {
                    if (num9 == 0)
                    {
                        rectangle.X = 54;
        ...
        if ((type == 1 || type == 2 || type == 6 || type == 7) && rectangle.X == -1 && rectangle.Y == -1)
        {
            ...
            if (num2 != -1 && index3 != -1 && index1 != -1 && index2 != -1)
            {
                ...
                else if (num2 == type && index3 == type && index1 == type && index2 == -2)
                {
                    ...
                    WorldGenerator.mergeRight = true;
                }
        ...
        {
            bool mergeUp = WorldGenerator.mergeUp;
            bool mergeDown = WorldGenerator.mergeDown;
            bool mergeLeft = WorldGenerator.mergeLeft;
            bool mergeRight = WorldGenerator.mergeRight;
            WorldGenerator.TileFrame(i - 1, j);
            WorldGenerator.TileFrame(i + 1, j);
            WorldGenerator.TileFrame(i, j - 1);
            WorldGenerator.TileFrame(i, j + 1);
            WorldGenerator.mergeUp = mergeUp;
            WorldGenerator.mergeDown = mergeDown;
            WorldGenerator.mergeLeft = mergeLeft;
            WorldGenerator.mergeRight = mergeRight;
        }
    }
}
  }
