    ...
    public IWorldObject MakeWO(Vector2 location, string woName)
    {
      ...
      switch (this.type)
      {
        case Preset.WOType.Static:
          ...
          worldObject = (IWorldObject) new Static(woName, this.sprite, location, this.hitbox, new Vector2?(new Vector2(location.X + this.epicenterOffset.X, location.Y + this.epicenterOffset.Y)))
          {
        ...
        case Preset.WOType.Growable:
          ...
          worldObject = (IWorldObject) new Growable(woName, this.growSprites, location, this.hitbox, new Vector2?(new Vector2(location.X + this.epicenterOffset.X, location.Y + this.epicenterOffset.Y)))
          {
            PresetMarker = this.name,
        ...
        case Preset.WOType.BuildPoint:
          this.sprite.autoUpdate = false;
          worldObject = (IWorldObject) new BuildPoint(woName, this.sprite, location, this.hitbox, new Vector2?(new Vector2(location.X + this.epicenterOffset.X, location.Y + this.epicenterOffset.Y)))
          {
            PresetMarker = this.name,
        ...
        case Preset.WOType.LinkingGrowable:
          ...
          worldObject = (IWorldObject) new LinkingGrowable(woName, this.growSprites, location, this.hitbox, new Vector2?(new Vector2(location.X + this.epicenterOffset.X, location.Y + this.epicenterOffset.Y)))
          {
            PresetMarker = this.name,
            growTime = this.growtime,
            mainGrowState = this.growstate,
        ...
        case Preset.WOType.Upgradable:
          this.sprite.autoUpdate = false;
          worldObject = (IWorldObject) new Upgradable(woName, this.sprite, location, this.hitbox, new Vector2?(new Vector2(location.X + this.epicenterOffset.X, location.Y + this.epicenterOffset.Y)))
          {
        ...
        case Preset.WOType.Hourglass:
          this.sprite.autoUpdate = false;
          worldObject = (IWorldObject) new Hourglass(woName, this.sprite, location, this.hitbox, new Vector2?(new Vector2(location.X + this.epicenterOffset.X, location.Y + this.epicenterOffset.Y)))
          {
            PresetMarker = this.name,
            ExtraFloorHeight = this.extraFloorHeight
          };
      ...
      else if (this.name == "UpgradableHouse" || this.name == "house2" || this.name == "house3" || this.name == "house4")
        Game1.SpawnDodo(location + new Vector2((float) this.sprite.Width / 2f, (float) this.sprite.height) + new Vector2(0.0f, 30f));
