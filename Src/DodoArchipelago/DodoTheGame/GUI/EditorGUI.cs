...
namespace DodoTheGame.GUI
{
  internal class EditorGUI : IGUI
  {
    ...
    public void AddPoint(Vector2 point, Game1 game)
    {
      ...
      this.backgroundPosition = new Vector2(game.dodoScreenLocation.X 
          - Game1.player.location.X, game.dodoScreenLocation.Y - Game1.player.location.Y);
    ...
    public void Draw(SpriteBatch spriteBatch, Game1 game, GameTime gameTime)
    {
      ...
      Recorder.RDraw(spriteBatch, Game1.redline, new Vector2(game.dodoScreenLocation.X, 
