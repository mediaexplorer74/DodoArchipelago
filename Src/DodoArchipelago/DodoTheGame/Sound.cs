    ...
    public static void Update(GameTime gametime, Game1 game)
    {
      ...
      if (!CutsceneManager.CutsceneActive)
      {
        ...
        if (Sound.timeSinceLastRandomBGMCheck > 2000.0)
        {
          ...
          if (num > 3000.0 && DayCycle.CurrentTime > 10.0 && DayCycle.CurrentTime < 275.0 && Game1.player.bgmThemeCount < 3 && (Sound.currentBGM == null || Sound.currentBGM.Status == BGMStatus.Stopped) && Game1.player.currentMovementType != Player.DodoMovement.Bicycle && Game1.RNG.Next(0, 10) == 1)
          {
