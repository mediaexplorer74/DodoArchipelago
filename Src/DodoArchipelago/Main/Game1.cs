...
namespace DodoTheGame
{
  ...
  public partial class Game1 : Game
  {
    ...
    public static bool isFullscreen = true;//true; // set it *true* for W10M

    // DEBUG MODE switch
    public static bool debugEnabled = false;//true for Dev mode, false for "Prod."... :)

    // W10M mode switch
    public static bool W10MEnabled = true; // set True to disable background tiles (W10M, Hello!)
