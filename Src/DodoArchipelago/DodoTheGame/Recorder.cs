  ...
  internal static class Recorder
  {
      ...
      float layerDepth)
    {
      ...
      if (Recorder.recording)
        Recorder.FrameRoutine();
      int int32 = Convert.ToInt32(Math.Ceiling(Math.Sqrt(Math.Pow((double) texture.Width, 2.0) + Math.Pow((double) texture.Height, 2.0))));
      if (!new Rectangle(Convert.ToInt32(position.X - (float) int32), Convert.ToInt32(position.Y - (float) int32), int32 * 2, int32 * 2).Intersects(new Rectangle(0, 0, 1280, 720)))
        return;
      ++Recorder.drawCallCount;
      ...
      Color color)
    {
      ...
      {
        Color color1 = (double) color.R * 0.299 + (double) color.G * 0.587 + (double) color.B * 0.114 <= 186.0 ? Color.White * 0.9f : Color.Black * 0.9f;
        Vector2 vector2 = spriteFont.MeasureString(text);
        spriteBatch.Draw(Recorder.GenerateBox(new Vector2(vector2.X + 4f, vector2.Y + 2f), Color.White), new Vector2(location.X - 2f, location.Y - 1f), color1);
      }
      ++Recorder.drawCallCount;
    ...
    public static void StartReRender(string folder, Game1 game)
    {
      ...
      Recorder.fileList = ((IEnumerable<string>) Recorder.fileList).OrderBy<string, string>(new Func<string, string>(Recorder.PadNumbers)).ToArray<string>();
    ...
    public static void Update(GameTime gameTime, Game1 game, SpriteBatch spriteBatch)
    {
      ...
      try
      {
        foreach (string[] strArray in Recorder.framesBuffer[Recorder.currentFrameIndexInCurrentFile])
        {
          ...
          if (elem[0] == "i")
          {
            Recorder.rERcolorFilter = new Color(Convert.ToInt32(elem[1]), Convert.ToInt32(elem[2]), Convert.ToInt32(elem[3]), Convert.ToInt32(elem[4]));
            Recorder.rERTime = new TimeSpan(0, 0, 0, 0, Convert.ToInt32(Math.Round(Convert.ToDouble(elem[5], (IFormatProvider) CultureInfo.InvariantCulture))));
            Recorder.rERinventory = Recorder.jss.Deserialize<ItemStack[]>(elem[6]);
          }
          else
          {
            Texture2D texture1 = Recorder.resources.FirstOrDefault<Texture2D>((Func<Texture2D, bool>) (texture => texture.Name == elem[1]));
            if (texture1 != null)
            {
              switch (elem[0])
              {
                case "a":
                  spriteBatch.Draw(texture1, new Vector2(Convert.ToSingle(elem[2], (IFormatProvider) CultureInfo.InvariantCulture), Convert.ToSingle(elem[3], (IFormatProvider) CultureInfo.InvariantCulture)), new Color(Convert.ToInt32(elem[4]), Convert.ToInt32(elem[5]), Convert.ToInt32(elem[6]), Convert.ToInt32(elem[7])));
                  continue;
                case "c":
                  spriteBatch.Draw(texture1, new Rectangle(Convert.ToInt32(elem[2]), Convert.ToInt32(elem[3]), Convert.ToInt32(elem[4]), Convert.ToInt32(elem[5])), new Rectangle?(new Rectangle(Convert.ToInt32(elem[6]), Convert.ToInt32(elem[7]), Convert.ToInt32(elem[8]), Convert.ToInt32(elem[9]))), new Color(Convert.ToInt32(elem[14]), Convert.ToInt32(elem[15]), Convert.ToInt32(elem[16])), Convert.ToSingle(elem[10], (IFormatProvider) CultureInfo.InvariantCulture), new Vector2((float) Convert.ToInt32(elem[11]), (float) Convert.ToInt32(elem[12])), (SpriteEffects) Convert.ToInt32(elem[13]), 0.0f);
                  continue;
                case "d":
                  spriteBatch.Draw(texture1, new Rectangle(Convert.ToInt32(elem[2]), Convert.ToInt32(elem[3]), Convert.ToInt32(elem[4]), Convert.ToInt32(elem[5])), new Rectangle?(), new Color(Convert.ToInt32(elem[10]), Convert.ToInt32(elem[11]), Convert.ToInt32(elem[12]), Convert.ToInt32(elem[13])), Convert.ToSingle(elem[5], (IFormatProvider) CultureInfo.InvariantCulture), new Vector2((float) Convert.ToInt32(elem[6]), (float) Convert.ToInt32(elem[7])), (SpriteEffects) Convert.ToInt32(elem[8]), 0.0f);
                  continue;
                case "e":
                  spriteBatch.Draw(texture1, new Vector2((float) Convert.ToInt32(elem[2]), (float) Convert.ToInt32(elem[3])), new Rectangle?(new Rectangle(Convert.ToInt32(elem[4]), Convert.ToInt32(elem[5]), Convert.ToInt32(elem[6]), Convert.ToInt32(elem[7]))), new Color(Convert.ToInt32(elem[8]), Convert.ToInt32(elem[9]), Convert.ToInt32(elem[10]), Convert.ToInt32(elem[11])), Convert.ToSingle(elem[12], (IFormatProvider) CultureInfo.InvariantCulture), new Vector2((float) Convert.ToInt32(elem[12]), (float) Convert.ToInt32(elem[13])), 1f, (SpriteEffects) Convert.ToInt32(elem[15]), 0.0f);
                  continue;
                case "f":
                  spriteBatch.Draw(texture1, new Vector2(Convert.ToSingle(elem[2], (IFormatProvider) CultureInfo.InvariantCulture), Convert.ToSingle(elem[3], (IFormatProvider) CultureInfo.InvariantCulture)), new Rectangle?(), new Color(Convert.ToInt32(elem[8]), Convert.ToInt32(elem[9]), Convert.ToInt32(elem[10]), Convert.ToInt32(elem[11])), Convert.ToSingle(elem[12], (IFormatProvider) CultureInfo.InvariantCulture), new Vector2((float) Convert.ToInt32(elem[13]), (float) Convert.ToInt32(elem[14])), 1f, (SpriteEffects) Convert.ToInt32(elem[15]), 0.0f);
                  continue;
                default:
